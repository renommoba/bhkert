...
load_dotenv()
IVASMS_EMAIL = os.getenv("hendricouy@gmail.com")
IVASMS_PASSWORD = os.getenv("Hendri01")
BOT_TOKEN = os.getenv("8680727619:AAHvzzhlAKg7UKFj-R6dDCwdfUDlSFsZTx8")
CHAT_ID = os.getenv("7705761344")
